...
INSERT INTO Cititor(CNP, prenume, nume, email, numar_telefon) VALUES
    ...
    ('6100715134196', 'Mihaela', 'Ionescu', 'mihaela.ionescu@gmail.com', '0745943941');
...
INSERT INTO EDITURA (CUI, nume, oras, numar_telefon, website, data_infiintare, reprezentant_legal) VALUES
    ('363367', 'Humanitas', 'Bucure?ti', '0214088350', 'www.humanitas.ro', TO_DATE('14/03/1994', 'DD/MM/YYYY'), 'Diana Constantinescu'),
    ('6494981', 'Paralela 45', 'Pite?ti', '0248214533', 'www.paralela45.ro', TO_DATE('07/12/1994', 'DD/MM/YYYY'), NULL),
    ('7726230', 'Editura Universitara', 'Bucure?ti', NULL, 'www.editurauniversitara.ro', TO_DATE('06/03/2002', 'DD/MM/YYYY'), 'Ion Popescu'),
    ('1456342', 'Vellant', 'Bucure?ti', '0213121345', 'www.vellant.ro', TO_DATE('20/06/2003', 'DD/MM/YYYY'), NULL),
    ('2345678', 'Trei', 'Bucure?ti', '0215612458', 'www.edituratrei.ro', TO_DATE('12/11/2005', 'DD/MM/YYYY'), 'Gabriela Popa'),
    ('4567890', 'Curtea Veche', 'Bucure?ti', '0216187123', 'www.curteaveche.ro', TO_DATE('25/07/2000', 'DD/MM/YYYY'), NULL),
    ('5678901', 'Humanitas Fiction', 'Bucure?ti', '0213123456', 'www.humanitasfiction.ro', TO_DATE('09/04/2010', 'DD/MM/YYYY'), 'Cristina M?ce?aru'),
    ('6789012', 'Ra?iu', 'Cluj-Napoca', '0264598745', 'www.ratiu.ro', TO_DATE('14/10/1998', 'DD/MM/YYYY'), NULL),
    ('7890123', 'Polirom', 'Ia?i', '0232124567', 'www.poliro.ro', TO_DATE('18/02/1995', 'DD/MM/YYYY'), NULL),
    ('8901234', 'Litera', 'Bucure?ti', '0214556667', 'www.litera.ro', TO_DATE('05/08/1991', 'DD/MM/YYYY'), 'Mihai Georgescu');
...
INSERT INTO Categorie (audienta, nume, gen) VALUES
    ...
    ('+18', 'Absurdit??i Existentiale', 'Existen?ialism'),
    ('+18', 'Realismul Magic în Lumea Modern?', 'Realism magic'),
    ('+18', 'Tragedii ?i Comedii Clasice', 'Rena?tere'),
    ('10-16', 'Distopie ?i Utopie', 'Distopie'),
    ('+18', 'Realismul Rus', 'Realism'),
    ('+7', 'Fic?iune Magic? Modern?', 'Fic?iune modern?'),
    ('10-16', 'Epopeea Greceasc?', 'Epoca clasic?'),
    ('10-16', 'Romantism Englez', 'Romantism'),
    ('10-16', 'Revist? literar?', 'Pa?optism');
...
INSERT INTO Autor(nume, nationalitate, curent_literar, interes_literar) VALUES
    ('Mihai Eminescu', 'Româna', 'Romantism', 'Poezie'),
    ...
    ('Lucian Blaga', 'Român?', 'Modernism', 'Misterul existen?ei');
...
INSERT INTO Carte_Cititor_Recenzie (id_recenzie, ISBN, CNP_Cititor) VALUES
    ...
    (7, '9789732234567', '1760908207248'),
    (3, '9789733234567', '6040412041027'),
    (4, '9789734234567', '1891221042546'),
    (5, '9789736234567', '2790511415898'),
